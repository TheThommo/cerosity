...
T0 knowledge for **Soccer** powers FLO sport context and FLO Brain RAG. Research using [`docs/T0_KB_RESEARCH_PROMPT.md`](../../T0_KB_RESEARCH_PROMPT.md).
...
- [ ] Governance aligned with **FIFA / IFAB Laws of the Game**
...
soccer/
├── README.md                 # this file
├── soccer_seed_data.json     # after research
├── knowledge/
├── legends/
├── quotes/
└── governance/
...
- [ ] `soccer_seed_data.json` reviewed — no fabricated quotes
- [ ] `flo_sport_contexts`: slug `soccer`, `context_text` synthesized, `is_active` only after QA
